              ...
              <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    required
                    class="w-full bg-white dark:bg-[#1e293b] text-gray-900 dark:text-white border border-gray-300 dark:border-[#324867] rounded-md px-4 py-2.5 appearance-none cursor-pointer"
                  >
