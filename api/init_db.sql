...
CREATE TABLE `t_incidents` (
  ...
  `alert_list` text,
  `graph_data` longtext,
  `graph_summary` longtext,
  PRIMARY KEY (`id`),
  KEY `idx_incident_id` (`incident_id`),
  KEY `idx_create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='事件表';
/*!40101 SET character_set_client = @saved_cs_client */;



DROP TABLE IF EXISTS `t_revoked_tokens`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
INSERT INTO `t_system_config` VALUES (1,'sys_version','0.4-alpha',NULL);


DROP TABLE IF EXISTS `t_toolkits_records`;

CREATE TABLE `t_toolkits_records` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `title` varchar(100) DEFAULT NULL COMMENT '标题',
  `app_id` varchar(100) DEFAULT NULL COMMENT '应用ID',
  `app_type` varchar(100) DEFAULT NULL COMMENT '应用类型',
  ...
  `event_id` varchar(45) DEFAULT NULL COMMENT 'event_id',
  PRIMARY KEY (`id`),
